...
<body>
    ...
    <!-- Start Insert, Delete, Update Alert Heading -->
    <?php
    if ($insert) {
    ...
    ?>
    <!-- End Insert, Delete, Update Alert Heading -->

    <!-- Start Form Body Start -->
    <div class="container my-4 container shadow m-5 p-3">
